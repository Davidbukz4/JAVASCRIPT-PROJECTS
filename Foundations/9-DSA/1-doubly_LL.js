...
class linkedList {
    ...
    addNodeStart (val) {
        ...
        if (!this.head) {
            ...
            // console.log('came here' + currentNode.prev.data)
...
dllist1.addNodeEnd(34);
dllist1.addNodeEnd(346);
dllist1.addNodeEnd(14);
dllist1.popStart();
dllist1.addNodeEnd(33);
dllist1.addNodeEnd(32);
dllist1.addNodeEnd(31);
dllist1.addNodeStart(100);
// dllist1.popEnd();
dllist1.printList();
console.log('-----------------');
